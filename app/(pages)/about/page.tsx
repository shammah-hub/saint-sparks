...
const services = [
  {
    image: "/bezier.svg",  // Note the forward slash for public directory
    ...
    <>
      ...
      <section className='p-[120px] min-h-screen'>
        <div className='flex justify-between items-center mb-12'>
          <h3 className='text-[56px] leading-tight'>What We<br/> Specialize In</h3>
      ...
      {/* Our Mission */}
       <section className="relative w-full px-4 py-16 flex justify-center items-center">
      <div className="relative bg-[#003366] text-white rounded-lg p-10 max-w-5xl w-full overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl bg-white inline-block rounded-2xl font-bold mb-6">Our Mission</h2>
